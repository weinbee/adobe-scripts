...
var reverseButton = panelSort.add("button", [10, 10, 50, 30], "REVERSE");

// Create the 'loop' button
var loopButton = panelSort.add("button", [10, 10, 50, 30], "LOOP");
...
reverseButton.onClick = function() {
  reverseSelectedLayersOrder(app.project.activeItem);
  app.activate();
};
      // 'sort' event handlers
      loopButton.onClick = function() {
...
function loopSelectedLayers() {
  ...
  var method = 'cycle';
  var comp = app.project.activeItem;
  var numSelectedLayers = comp.selectedLayers.length;
...
// Define reverseSelectedLayersOrder
function reverseSelectedLayersOrder() {
  var comp = app.project.activeItem;
  ...
  for (var i = 0; i < Math.floor(numSelectedLayers / 2); i++) {
    var topLayer = selectedLayers[i];
    var bottomLayer = selectedLayers[numSelectedLayers - i - 1];
    topLayer.moveTo(numSelectedLayers - i);
    bottomLayer.moveTo(i + 1);
  }
  app.endUndoGroup();  
}  
