...
vers = "4.4"; // change version number here and it gets updated in the panel's name
(function createDockablePanel(thisObj) {
    function buildUI(thisObj) {
        ...
        */
        ...
        var iconButtA = col1Butts.add("button", undefined, "░▄▀▀░▄▀▄▒█▀▄░▀█▀ \n ▒▄██░▀▄▀░█▀▄░▒█▒");
        ...
        var iconButtG = col2Butts.add("button", undefined, "SmartXY");
