...
var row1Butts = panelAsSortment.add("group", undefined, {name: "row1Butts"}); 
    ...
    var sortButton = row1Butts.add("button", undefined, "Sort \u1F4C2");
    sortButton.alignment = ["center", "center"];
    
var nullButton = row1Butts.add("button", undefined, "Null");
var reverseButton = row1Butts.add("button", undefined, "Rvrs");
var loopButton = row1Butts.add("button", undefined, "Loop");
