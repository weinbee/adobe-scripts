...
(function createDockablePanel(thisObj) {
	function buildUI(thisObj) {
		var windowNERDS = (thisObj instanceof Panel) ? thisObj : new Window("palette", "NERDS_v4.1.1.2.3", undefined, {
			resizeable: true
		});
...
var iconButtH = col2Butts.add("button", undefined, "Precomp1x1");
...
// DROPDOWN1
var dropdown_array = ["Tasks", "Sort", "Null", "Loop", "Reverse", "Color", "Clear Render Queue"]; 
...
slider.onChange = function() {
    // Apply easing whenever the slider changes
    applyEasing(parseFloat(valueText.text), dropdown.selection.text.toLowerCase());
};

// Easing dropdown
var dropdownGroup = panelEasement.add("group");
dropdownGroup.orientation = "row";
var dropdown_array = ["In", "Out", "Both"]; 
var dropdown = dropdownGroup.add("dropdownlist", undefined, undefined, {name: "dropdown", items: dropdown_array}); 
dropdown.selection = 0;
...
// #region 'Precompose Individually'
//==================================
...
// #endregion 'Precompose Individually'

// #region 'Clear Render Queue'
//=============================
