(function createDockablePanel(thisObj) {
	function buildUI(thisObj) {
		...
		var tabbedPanel = windowNERDS.add('tabbedpanel');
		var mainTab = tabbedPanel.add('tab', undefined, 'Main');
		var renameTab = tabbedPanel.add('tab', undefined, 'Rename');
		
		// Move all your main UI creation code to mainTab
		mainTab.orientation = "column";
		mainTab.alignChildren = ["center", "top"];
		mainTab.spacing = 0;
		mainTab.margins = 5;
		...
		// PANELMISC
		// =========
		var panelMISC = grpTop.add("panel", undefined, undefined, {
			name: "panelMISC"
		});
		panelMISC.text = "MISC";
		...
		var iconSortButt = panelMISC.add("iconbutton", undefined, File.decode(iconSortButt_imgString), {
			name: "iconSortButt",
			style: "toolbutton"
		});
		iconSortButt.text = "miscA";

		var iconSortButt1 = panelMISC.add("iconbutton", undefined, File.decode(iconSortButt_imgString), {
			name: "iconSortButt1",
			style: "toolbutton"
		});
		iconSortButt1.text = "miscB";

		var iconSortButt2 = panelMISC.add("iconbutton", undefined, File.decode(iconSortButt_imgString), {
			name: "iconSortButt2",
			style: "toolbutton"
		});
		...
		// GRPDIV1
		// =======
		var grpDiv1 = grpTop.add("group", undefined, {
			name: "grpDiv1"
		});
		...
		var divider1 = grpDiv1.add("panel", undefined, undefined, {
			name: "divider1"
		});
		...
		// GRPDIV2
		// =======
		var grpDiv2 = windowNERDS.add("group", undefined, {
			name: "grpDiv2"
		});
		...
		var divider2 = grpDiv2.add("panel", undefined, undefined, {
			name: "divider2"
		});
		...
		var iconButtA = col1Butts.add("iconbutton", undefined, File.decode(iconButtA_imgString), {
			name: "iconButtA",
			style: "toolbutton"
		});
		iconButtA.text = "SORT";
		...
		var iconButtB = col1Butts.add("iconbutton", undefined, File.decode(iconButtB_imgString), {
			name: "iconButtB",
			style: "toolbutton"
		});
		iconButtB.text = "NULL";
		...
		var iconButtC = col1Butts.add("iconbutton", undefined, File.decode(iconButtC_imgString), {
			name: "iconButtC",
			style: "toolbutton"
		});
		iconButtC.text = "LOOP";
		...
		var iconButtD = col1Butts.add("iconbutton", undefined, File.decode(iconButtC_imgString), {
			name: "iconButtD",
			style: "toolbutton"
		});
		iconButtD.text = "REVERSE";

		var iconButtE = col1Butts.add("iconbutton", undefined, File.decode(iconButtB_imgString), {
			name: "iconButtE",
			style: "toolbutton"
		});
		...
		// GRPDIV3
		// =======
		var grpDiv3 = grpMainButts.add("group", undefined, {
			name: "grpDiv3"
		});
		...
		var divider3 = grpDiv3.add("panel", undefined, undefined, {
			name: "divider3"
		});
		...
		var iconButtF = col2Butts.add("iconbutton", undefined, File.decode(iconSortButt_imgString), {
			name: "iconButtF",
			style: "toolbutton"
		});
		iconButtF.text = "BLINK";

		var iconButtG = col2Butts.add("iconbutton", undefined, File.decode(iconSortButt_imgString), {
			name: "iconButtG",
			style: "toolbutton"
		});
		...
		var iconButtH = col2Butts.add("iconbutton", undefined, File.decode(iconButtC_imgString), {
			name: "iconButtH",
			style: "toolbutton"
		});
		iconButtH.text = "UNPRECOMP";

		var iconButtI = col2Butts.add("iconbutton", undefined, File.decode(iconButtC_imgString), {
			name: "iconButtI",
			style: "toolbutton"
		});
		iconButtI.text = "SMART XY";

		var iconButtJ = col2Butts.add("iconbutton", undefined, File.decode(iconButtC_imgString), {
			name: "iconButtJ",
			style: "toolbutton"
		});
		iconButtJ.text = "RENAME";

		// GRPDIV4
		// =======
		var grpDiv4 = windowNERDS.add("group", undefined, {
			name: "grpDiv4"
		});
		...
		var divider4 = grpDiv4.add("panel", undefined, undefined, {
			name: "divider4"
		});
		...
		// GRPEASEMENT
		// ===========
		var grpEasement = windowNERDS.add("group", undefined, {
			name: "grpEasement"
		});
...
// Then, in your event listener for iconButtJ, instead of creating a new Window, you just change the selected tab:
iconButtJ.onClick = function() {
    tabbedPanel.selection = renameTab;
    buildRenameUI(renameTab);
    app.activate();
}
