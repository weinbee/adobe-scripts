...
vers = "4.7"; // change version number here and it gets updated in the panel's name
(function createDockablePanel(thisObj) {
    function buildUI(thisObj) {
        ...
        */
        ...
        var iconButtC = col1Butts.add("button", undefined, "➰    LѻѻP    ⌚");
            // iconButtC = loopAtPlayhead
            iconButtC.onClick = function () {
            loopAtPlayhead();
            app.activate();
            };
        var iconButtD = col1Butts.add("button", undefined, "➰    ƎSᴚƎΛƎᴚ    ⌚\nLAYER ORDER");
        ...
        var utilities_array = ["Utilities", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Calculate Distance Between Keyframes", "Precompose Individually", "Round Position",  "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Select All Children", "Select All Non-Nulls", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Lock All Nulls", "Unlock All Nulls", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Lock All Layers", "Unlock All Layers"];
        ...
        housekeepingDropdown.onChange = function () {
            ...
            this.selection = 0; // Assuming "Housekeeping" is the first option
        };
        ...
        utilitiesDropdown.onChange = function () {
            ...
            this.selection = 0; // Assuming "Utilities" is the first option
        };
        // #endregion UI stuff
