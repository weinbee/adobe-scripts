...
vers = "4.9"; // change version number here and it gets updated in the panel's name
...
var iconButtSize = [0, 0, 100, 25];
        ...
        var iconButtA = col1Butts.add("button", iconButtSize, "⧼s̼⧽ ⧼o̼⧽ ⧼r̼⧽ ⧼t̼⧽");
        ...
        var iconButtC = col1Butts.add("button", iconButtSize, "➰  ℓѻѻP  ⌚");
        ...
        var iconButtE = col2Butts.add("button", iconButtSize, "𝖈𝖔𝖑𝖔𝖗");
        iconButtE.onClick = function () {
            colorPicker();
            app.activate();
        };
        // iconButtF = batch renamer
        var iconButtF = col2Butts.add("button", iconButtSize, "ミ💖 𝓇𝑒𝓃𝒶𝓂𝑒 💖彡");
        ...
        var iconButtG = col2Butts.add("button", undefined, "≒ SMART X/Y ≒");
        ...
        var utilities_array = ["Utilities", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Calculate Distance Between Keyframes", "Precompose Individually", "Round Position", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Select All Children", "Select All Non-Nulls", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Lock All Nulls", "Unlock All Nulls", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Lock All Layers", "Unlock All Layers", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Scale Composition", ];

        var housekeepingDropdown = grpDropDown.add("dropdownlist", undefined, undefined, { name: "housekeepingDropdown", items: housekeeping_array });
        var utilitiesDropdown = grpDropDown.add("dropdownlist", undefined, undefined, { name: "utilitiesDropdown", items: utilities_array });
