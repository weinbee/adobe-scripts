...
vers = "4.9.3.3"; // change version number here and it gets updated in the panel's name
...
//#region 'var strings'
var strings = {helpTips: {loop: "Select a precomp, move timeline indicator to where you want the end of your loop, and press this button!"}};
...
//#region UI stuff     
        ...
        // DROPDOWNS
        var housekeeping_array = ["Housekeeping", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Sort", "Reduce Project", "Collect Files...", "⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀", "Rename Comp to File Name", "Clear Render Queue", "Purge All Memory & Disk Cache"];
...
//#region 'Misc for dropdowns'
        ...
        var cmdIDPurge = app.findMenuCommandId('All Memory & Disk Cache...');
        app.executeCommand(cmdIDPurge);
        }

        ///// 'Collect Files...' /////
        var doCollectFiles = function() {
        var cmdIDCollect = app.findMenuCommandId('Collect Files...');
        app.executeCommand(cmdIdcollect);
        }

        ///// 'Reduce Project' /////
        var doReduceProject = function() {
        var cmdIDReduceProject = app.findMenuCommandId('Reduce Project');
        app.executeCommand(cmdIDReduceProject);
        }
