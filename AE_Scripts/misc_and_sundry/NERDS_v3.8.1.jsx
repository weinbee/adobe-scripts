...
var panelFour = rightGroup.add("panel", undefined, "Clone");
panelFour.orientation = "row";
// Create the 'pasteMultipleKeyframes' button
var cloneButton = panelFour.add("button", [10, 10, 45, 30], "Clone");
...
//=================
      ...
      function sortProjectItems() {
        ...
        var imageExtensions = ['eps', 'ps', 'pdf', 'bmp', 'rle', 'dib', 'tif', 'crw', 'nef', 'raf', 'orf', 'mrw', 'dcr', 'mos', 'raw', 'pef', 'srf', 'dng', 'x3f', 'cr2', 'erf', 'cin', 'dpx', 'gif', 'rla', 'rpf', 'img', 'ei', 'iff', 'tdi', 'jpg', 'jpe', 'heif', 'heic', 'ma', 'exr', 'pcx', 'png', 'hdr', 'rgbe', 'xyze', 'sgi', 'bw', 'rgb', 'pic', 'tga', 'vda', 'icb', 'vst'];
      ...
      // Remove 'Old Folders'
  var oldFolder = findFolder(folderTypes.OldFolders.name);
