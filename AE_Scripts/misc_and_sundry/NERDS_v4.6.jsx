...
vers = "4.6"; // change version number here and it gets updated in the panel's name
(function createDockablePanel(thisObj) {
    function buildUI(thisObj) {
        ...
        */
        ...
        // DROPDOWN1
        var dropdown_array = ["Tasks", "Clear Render Queue", "Calculate Distance Between Keyframes", "Precompose Individually", "Lock All Nulls", "Unlock All Nulls", "Lock All Layers", "Unlock All Layers", "Round Position", "Rename Comp to File Name", "Select All Children", "Select All Non-Nulls", "Purge All Memory & Disk Cache"];
