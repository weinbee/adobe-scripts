...
//#region UI stuff
        ...
        */
        ...
        // col1flipGrp is for the flip X / flip Y buttons I added in v4.9.4.8
        var col1flipGrp = col1Butts.add("group", undefined, {
        });
            col1flipGrp.orientation = "row";
            col1flipGrp.alignChildren = ["center", "center"];
